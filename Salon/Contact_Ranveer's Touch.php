...
<html>
    ...
    <ul class="navbar">
        ...
        <li><a class="active" href="Contact_Ranveer's Touch.php">Contact</a>
    ...
    <form action="Contact_insert.php" method="POST">
        ...
        <textarea name="message" placeholder="Enter your message here" cols="40" rows="6" maxlength="1000" required></textarea><br><br>
